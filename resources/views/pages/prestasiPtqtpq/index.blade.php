  ...
  <div class="page-title">
      <div class="row">
          <div class="col-12 col-md-6 order-md-1 order-last">
              <h3 class="text-uppercase">lembar prestasi PTQ dan TPQ</h3>
          </div>
          <div class="col-12 col-md-6 order-md-2 order-first">
              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                  <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                      <li class="breadcrumb-item active" aria-current="page">prestasi ptq dan tpq</li>
                  </ol>
              </nav>
          </div>
      </div>
  ...
  <section class="section">
      <div class="card">
          <div class="card-header">
             <a href="{{route('prestasiptqtpq.create')}}" class="btn btn-sm btn-success my-2 mx-2 text-uppercase">+ tambah</a>
             <a href="{{route('export-prestasiptqtpq')}}" class="btn btn-sm btn-primary my-2 mx-2 text-uppercase">export excel</a>
          </div>
