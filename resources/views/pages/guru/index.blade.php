  ...
  <div class="page-title">
      <div class="row">
          <div class="col-12 col-md-6 order-md-1 order-last">
              <h3 class="text-uppercase">guru</h3>
              <p class="text-subtitle text-muted text-capitalize">data guru</p>
          </div>
  ...
  <section class="section">
      <div class="card">
          <div class="card-header">
             <a href="{{route('guru.create')}}" class="btn btn-sm btn-success my-2 mx-2">+ tambah</a>
             <a href="{{route('export_guru')}}" class="btn btn-sm btn-outline-primary my-2 mx-2">export excel</a>
              ...
              <table class="table table-striped" id="crudTable">
                  <thead>
                      <tr>
                          ...
                          <th class="text-uppercase">tmt</th>
