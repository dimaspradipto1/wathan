...
<div class="container-fluid px-0 mb-5">
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            @forelse ($hero as $key => $item)
                <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                    <img class="w-90" src="{{ $item->image ? Storage::url($item->image) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}" alt="Image" style="height: 70vh; object-fit: cover; width: 100%;">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <strong class="text-dark">{{$item->judul}}</strong></p>
                                    <h1 class="display-1 text-dark mb-4 animated zoomIn text-white text-uppercase" style="font-size: 50px">{{$item->deskripsi}}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @empty
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('landingpage/img/bg-nwbatam.jpg') }}" alt="No Image" style="height: 70vh; object-fit: cover; width: 100%;">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <strong class="text-dark">Our Website</strong></p>
                                    <h1 class="display-1 text-dark mb-4 animated zoomIn text-white text-uppercase" style="font-size: 50px">Welcome</h1>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row g-5">
            <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                <div class="text-center">
                    <img class="img-fluid" src="{{asset('landingpage/img/pemilik.png')}}" alt="">
        ...
        <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
            @forelse ($galleries as $item)
                <a href="" class="d-block product-item rounded">
                    <img src="{{ $item->image ? Storage::url($item->image) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}" alt="Gallery Image" style="width: 100%; height: 200px; object-fit: cover;">
                </a>
            @empty
                <a href="" class="d-block product-item rounded">
                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="No Gallery Image" style="width: 100%; height: 200px; object-fit: cover;">
                </a>
            @endforelse
        </div> 
    </div>
    ...
    <div class="container">
        <div class="row g-0">
            <div class="col-lg-6 py-5 wow fadeIn" data-wow-delay="0.1s">
                <div class="py-5">
                    <h1 class="display-6 mb-4 text-capitalize">keunggulan yayasan darul qur'an wal hadits <span class="text-white"> Nadhlatul Wathan </span> batam</h1>
