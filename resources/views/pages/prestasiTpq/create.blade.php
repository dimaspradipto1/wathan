        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3 class="text-capitalize">form lembar prestasi TPQ</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">form lembar prestasi TPQ</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title text-capitalize">form lembar prestasi TPQ</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('prestasitpq.store') }}" class="form form-horizontal" method="POST">
                                    @csrf
