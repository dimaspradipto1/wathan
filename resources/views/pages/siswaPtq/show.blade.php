        ...
        <div class="col-md-6 col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Form Siswa PTQ</h4>
            </div>
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-4">
                      ...
                      <div class="col-sm-12 d-flex justify-content-end">
                        <a href="{{route('siswaptq.index')}}" class="btn btn-sm btn-warning text-white my-2 mx-2"><i class="fa-solid fa-right-to-bracket"></i> back</a>
                      </div>
                    </div>
                  </div>
                </form>
