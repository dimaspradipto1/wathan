...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">pengurus Pondok</h6>
                                        <h6 class="font-extrabold mb-0">{{ $pengurusPondok }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $fasilita }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @push('script')
        <script>
            ...
            var chartContainer = document.querySelector("#chart-profile-visit");
