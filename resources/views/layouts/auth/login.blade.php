    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="{{route('landingpage')}}"><img src="{{asset('dashboard/assets/images/logo/logo.png')}}" alt="Logo" style="width: 50px; height: 50px;"></a>
                    </div>
                    <h2 class="">Log in.</h2>
                    ...
                    <div class="text-center mt-5 fs-4">
                        ...
                        <p>
                          <p class="text-gray-600"><i class="fa-solid fa-arrow-left"></i> <a href="{{route('landingpage')}}" class="font-bold">kembali ke homepage</a>.</p> 
                        <p>
                    </div>
                </div>
            </div>
