        ...
        <div class="col-md-6 col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form action="{{route('bacaan-wudhu-sholat.update', $bacaanWudhuSholat->id)}}" class="form form-horizontal" method="POST">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-8 form-group">
                       <input type="text" name="bacaan" value="{{old('bacaan') ?? $bacaanWudhuSholat->bacaan}}" class="form-control" placeholder="bacaan">
                      </div>
