                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('surat.update', $surat->id) }}" class="form form-horizontal" method="POST"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" name="nama_surah" value="{{ old('nama_surah') ?? $surat->nama_surah }}"
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="number" name="jumlah_ayat" value="{{ old('jumlah_ayat') ?? $surat->jumlah_ayat }}"
