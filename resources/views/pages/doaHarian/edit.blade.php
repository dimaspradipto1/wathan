        ...
        <div class="col-md-6 col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form action="{{route('doa-harian.update', $doaHarian->id)}}" class="form form-horizontal" method="POST">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-8 form-group">
                       <input type="text" name="doa_harian" value="{{old('doa_harian') ?? $doaHarian->doa_harian }}" class="form-control" placeholder="doa harian">
                      </div>
