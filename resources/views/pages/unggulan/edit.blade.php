        ...
        <div class="col-md-6 col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form action="{{route('unggulan.update', $unggulan->id)}}" class="form form-horizontal" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-8 form-group">
                       <textarea name="deskripsi" id="" class="form-control" cols="30" rows="5">{{old('deskripsi') ?? $unggulan->deskripsi}}</textarea>
                      </div>
