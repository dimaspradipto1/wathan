  ...
  <div class="page-title">
      <div class="row">
          <div class="col-12 col-md-6 order-md-1 order-last">
              <h3 class="text-uppercase">lembar prestasi TPQ</h3>
          </div>
  ...
  <section class="section">
      <div class="card">
          <div class="card-header">
             <a href="{{route('prestasitpq.create')}}" class="btn btn-sm btn-success my-2 mx-2 text-uppercase">+ tambah</a>
             <a href="{{route('export-prestasitpq')}}" class="btn btn-sm btn-primary my-2 mx-2 text-uppercase">export excel</a>
          </div>
