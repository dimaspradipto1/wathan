        ...
        <div class="col-md-6 col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form action="{{route('fasilitas.store')}}" class="form form-horizontal" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-8 form-group">
                      <input type="text" name="subjudul" value="{{old('subjudul')}}" class="form-control" placeholder="subjudul">
                      </div>
