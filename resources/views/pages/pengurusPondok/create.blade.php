        ...
        <div class="col-md-6 col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form action="{{route('pengurus-pondok.store')}}" class="form form-horizontal" method="POST">
                  @csrf
                  ...
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-8 form-group">
                       <input type="text" name="nama"  value="{{old('nama')}}" class="form-control" placeholder="nama pengurus poiondok">
                      </div>
                      ...
                      <div class="col-md-8 form-group">
                       <input type="number" name="nohp" value="{{old('nohp')}}" class="form-control" placeholder="nohp">
                      </div>
